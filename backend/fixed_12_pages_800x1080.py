...
def generate_12_pages_800x1080(frame_files, bubbles):
    ...
    print(f"📄 Generating {total_pages} pages at 800x1080 resolution")
    ...
    for page_num in range(total_pages):
        ...
        if panels_on_page > 0:
            print(f"  ✓ Page {page_num + 1}: {panels_on_page} panels (800x1080)")
    
    print(f"✅ Generated {len(pages)} pages at 800x1080 with {min(num_frames, target_panels)} total panels")
    return pages
